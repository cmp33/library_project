package com.cesi.database.db;

import com.cesi.database.controllers.*;
import com.cesi.database.models.*;
...
public class LibraryDatabase extends DatabaseModel<ResultSet, HashMap<String, Object>> {
    ...
    protected void onInsertDefaultValues() {
        ...
        Category[] categories = new Category[]{
                ...
                new Category("Jeux-Vidéo", "projetLibrairydatabase", false, null)
        };
